    ...
    const sideList = (
      <div className={classes.list}>
        <div className="navbar-drawer-header">
          ...
          <div className="navbar-drawer-text">Manage_Film_Example</div>
        </div>
        <Divider />
        <List>
          {/* START LINK MENU */}
           ...
           <Link to="/actors">
            <ListItem button key="Actor">
              <ListItemIcon>
                <ArrowForwardIos />
              </ListItemIcon>
              <ListItemText className="menu-text" primary="Actor" />
            </ListItem>
          </Link>{" "}            
           <Link to="/films">
            <ListItem button key="Film">
              ...
              <ListItemText className="menu-text" primary="Film" />
            </ListItem>
          </Link>{" "}            
           <Link to="/filmmakers">
            <ListItem button key="FilmMaker">
              <ListItemIcon>
                <ArrowForwardIos />
              </ListItemIcon>
